...
问题在 validation 阶段发现，正式 test 未打开。原始训练 run 保留：https://swanlab.cn/@richliu0153/MiniMind-Lab/runs/89ptosrv。修复只改变数据联合分配和 auditor，正式对照改名 R02A/B/C/D。
