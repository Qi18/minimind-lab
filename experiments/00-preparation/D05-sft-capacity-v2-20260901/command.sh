...
EXPERIMENT_DIR="$ROOT_DIR/experiments/00-preparation/D05-sft-capacity-v2-20260901"
PROFILE_CONFIG="$EXPERIMENT_DIR/config.json"
PROFILER="$ROOT_DIR/experiments/00-preparation/D05-sft-capacity-v2-20260901/tools/profile_sft_v2_capacity.py"
