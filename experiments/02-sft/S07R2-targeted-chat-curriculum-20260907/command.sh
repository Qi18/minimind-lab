...
torchrun --nproc_per_node=7 train_sft_with_validation.py \
  --save_dir /data/artifacts/minimind-lab/S07R2-targeted-chat-curriculum-20260907/checkpoints \
  ...
  --split_manifest /data/artifacts/minimind-lab/S07R2-targeted-chat-curriculum-20260907/split/manifest.json \
  --metrics_path /data/artifacts/minimind-lab/S07R2-targeted-chat-curriculum-20260907/metrics/metrics.jsonl \
  --use_swanlab --swanlab_project MiniMind-Lab \
  --swanlab_run_name S07R2-targeted-chat-curriculum --use_compile 0
